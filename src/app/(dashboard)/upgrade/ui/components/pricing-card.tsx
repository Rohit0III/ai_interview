...
const pricingCardSecondaryVariants = cva(" text-netural-700",{
    variants:{
          variant:{
            default: " text-netural-700",
            highlighted: "text-netural-300",
          }
    },
    defaultVariants:{
        variant:"default"
    ...
    return(
        <div className={cn(pricingCardVariants({variant}),className,"border")}>
            <div className="flex items-end gap-x-4 justify-between">
                <div className="flex flex-col gap-y-2">
                    <div className="flex items-center gap-x-2">
                       ...
                       {badge ? (<Badge className={cn(pricingCardBadgeVariants({variant}))}>
                        {badge}
                       </Badge>)  : null}
                    </div>
                    <p className={cn("text-xs",pricingCardSecondaryVariants({variant}))}>
                        {description}
                    </p>
                </div>
          ...
          <div className="flex flex-col gap-y-2 mt-6 ">
            ...
            <ul 
            className={cn("flex flex-col gap-y-2.5",pricingCardSecondaryVariants({variant}))}>
